...
public class GestionPanel2 {
	...
	private static void formAgregarAsistencia(GridPane panel, Invitado invitado) {
		...
		btnGuardar.setOnAction(e -> {
			...
			// Agregar la asistencia al invitado (el método agregarAsistencia genera el código automáticamente)
	...
	/**
	 * Método gráfico: Crea VBox con checkboxes dinámicos basados en las secciones disponibles
	 * @return VBox conteniendo un checkbox por cada sección
	 */
